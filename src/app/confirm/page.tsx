...
export default async function ConfirmPage({ searchParams }: any) {
    ...
    return (
        <section className="min-h-screen flex justify-center content-center bg-gradient-to-b from-green-200 to-green-400 pb-8 dark:from-green-500 dark:to-green-700">
            <article
                className="rounded-md p-4 min-h-[520px] mt-6 bg-white dark:bg-zinc-800 max-w-[350px] flex flex-col gap-4 content-center">
                ...
                <span className="text-sm text-black dark:text-neutral-400 text-center">{decodedInfo.email}</span>
                <p
                    className="text-center text-neutral-500 dark:text-neutral-200 md:text-xl lg:text-base">
