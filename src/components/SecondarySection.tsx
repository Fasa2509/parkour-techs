...
export const SecondarySection = () => {
    ...
    return (
        <section className="w-full min-h-screen content-center bg-gradient-to-b from-green-200 to-green-400 dark:from-green-500 dark:to-green-700">
            <div className="container px-4 md:px-6">
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                    <div className="space-y-2">
                        ...
                        <p className="max-w-[900px] text-neutral-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-neutral-300">
                ...
                <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-10">
                    ...
                    <div className="flex flex-col justify-center space-y-4">
                        <p
                            className="text-neutral-500 dark:text-neutral-200 md:text-xl lg:text-base xl:text-xl text-justify"
